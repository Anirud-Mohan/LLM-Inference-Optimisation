...
For the full analysis — including the batch engine architecture, GPU utilization, and the LLM-as-a-judge quality evaluation — see [`llm-qwen-deployment/README.md`](llm-qwen-deployment/README.md).
